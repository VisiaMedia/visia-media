<?php if(get_sub_field('formuliernaam') && get_sub_field('bedanktpagina')) {
	...
	$sectionID = wp_unique_id('presentation-form-');
	$headlineID = $sectionID.'-headline'; ?>

	<section class="presentation-form js-presentation-form" data-st-count="<?php $scrollTriggerCount--; echo $scrollTriggerCount; ?>"<?php echo $headline ? ' aria-labelledby="'.esc_attr($headlineID).'"' : ''; ?>>
		<?php if($headline) { ?>
			<div class="presentation-form__intro js-presentation-form-intro js-section-reveal">
				<div class="css-max-text-width">
					<h1 id="<?php echo esc_attr($headlineID); ?>" class="presentation-form__intro__title css-title js-presentation-form-vertical-text-reveal"><?php echo do_shortcode($headline); ?></h1>
				</div>
			</div>
		<?php } ?>

		<div class="presentation-form__content js-presentation-form-content js-section-reveal">
			<div class="css-max-text-width">
                <form class="presentation-form__content__form css-big-form js-form js-big-form js-presentation-form-self" name="<?php esc_attr_e($formName); ?>" method="POST" data-netlify="true" data-swup-form="true" action="<?php echo substr(get_permalink(get_sub_field('bedanktpagina')), strlen(home_url())); ?>">
                    ...
                    <label class="css-big-form-label js-big-form-field" for="<?php esc_attr_e($formName); ?>-first-name" data-label-num="01">
                        ...
                        <input class="css-big-form-input js-big-form-field-input js-presentation-form-first-name" type="text" name="first-name" id="<?php esc_attr_e($formName); ?>-first-name" required="true" aria-required="true" aria-describedby="<?php esc_attr_e($formName); ?>-first-name-error" aria-errormessage="<?php esc_attr_e($formName); ?>-first-name-error" aria-invalid="false" placeholder="<?php esc_attr_e('First name', 'visia'); ?> *">
                    ...
                    <label class="css-big-form-label js-big-form-field" for="<?php esc_attr_e($formName); ?>-business" data-label-num="03">
                        ...
                        <input class="css-big-form-input js-big-form-field-input js-presentation-form-business" type="text" name="business" id="<?php esc_attr_e($formName); ?>-business" required="true" aria-required="true" aria-describedby="<?php esc_attr_e($formName); ?>-business-error" aria-errormessage="<?php esc_attr_e($formName); ?>-business-error" aria-invalid="false" placeholder="<?php esc_attr_e('Business name', 'visia'); ?> *">
